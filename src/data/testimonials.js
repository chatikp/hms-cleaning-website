export const testimonials = [
  {
    id: 1,
    name: 'Amanda Reyes',
    role: 'Homeowner, Shaker Heights',
    rating: 5,
    quote:
      'HMS has cleaned our home biweekly for two years and it never stops feeling like a first impression. The team is punctual, thorough, and genuinely kind.',
  ...
  },
  {
    id: 5,
    name: 'Renee Castillo',
    role: 'Property Manager, Warehouse District Lofts',
    rating: 5,
    quote:
      'Fast turnaround between tenants and always flawless. Their team communicates proactively, which makes my job so much easier.',
    service: 'Commercial Cleaning',
  },
  {
    id: 6,
    name: 'Tom Bell',
    role: 'Homeowner, Ohio City',
    rating: 5,
    quote:
